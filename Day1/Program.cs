...
static void sortByName(List<Product> products)
{
    ...
    for (int k = 0; k < products.Count; k++)
    {
        Console.WriteLine("");
        Console.WriteLine("Thông tin sản phẩm");
        Console.WriteLine("Tên sản phẩm : " + products[k].getName());
        Console.WriteLine("Giá sản phẩm: " + products[k].getPrice());
        Console.WriteLine("Số lượng sản phẩm" + products[k].getQuantity());
        Console.WriteLine("Mã danh mục  : " + products[k].getCategoryId());
    }
}
...
static void minByPrice(List<Product> products)
{
    ...
    Console.WriteLine("Thông tin sản phẩm");
    Console.WriteLine("Tên sản phẩm : " + product.getName());
    Console.WriteLine("Giá sản phẩm: " + product.getPrice());
    Console.WriteLine("Số lượng sản phẩm" + product.getQuantity());
    Console.WriteLine("Mã danh mục  : " + product.getCategoryId());
}
